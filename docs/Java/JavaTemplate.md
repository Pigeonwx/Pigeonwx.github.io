...
![java-basic-generic-4](./JavaTemplate/java-basic-generic-4.png)

- 调用泛型方法语法格式

![java-basic-generic-5](./JavaTemplate/java-basic-generic-5.png)
...
![java-basic-generic-1](./JavaTemplate/java-basic-generic-1.png)
...
![java-basic-generic-2](./JavaTemplate/java-basic-generic-2.png)

- 擦除方法定义中的类型参数

擦除方法定义中的类型参数原则和擦除类定义中的类型参数是一样的，这里仅以擦除方法定义中的有限制类型参数为例。

![java-basic-generic-3](./JavaTemplate/java-basic-generic-3.png)
